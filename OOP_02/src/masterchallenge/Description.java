...
public class Description {
	...
	The first four methods do not return values, but the last method does return the total price of the hamburger of type double, which includes the base price of the hamburger plus any additional items and the names of any additional items. 
	...
	The constructor for this class accepts two(2) parameters for meat and price. Those are set in the constructor along with an appropriate name for the type of burger. 
	...
	Example output:
	One order of Basic hamburger on aWhite roll with Sausage with Tomato Lettuce Cheese null, price is 3.56
	Added Tomato for an extra 0.27
	Added Lettuce for an extra 0.75
	Added Cheese for an extra 1.13
	Total Burger price is 5.71
	One order of Healthy hamburger on aBrown rye roll with Bacon with Egg null null null, price is 5.67
	...
	One order of Deluxe hamburger on aSesame Bun roll with Bacon & Cheese with Chips Drink null null, price is 19.1
